...
const rules = {
  ...
  apiKey: [
    { required: true, message: '请输入智谱AI API Key', trigger: 'blur' }
  ]
}
    ...
    <div class="form-section">
      <div class="form-container" :class="{ show: showText }">
        <div class="form-header">
          ...
          <p class="subtitle">加入元启，开启智能之旅</p>
        </div>
      ...
      <div class="dialog-content">
        ...
        <div class="info-list">
          ...
          <div class="info-item">
            ...
            <div class="info-text">
              <strong>数据安全</strong>
              <span>密码和 API Key 均加密存储，请放心使用</span>
            </div>
          </div>
        ...
        <div class="sponsor-section">
          ...
          <p class="sponsor-desc">您唯一需要担心的是本人续费不起服务器 😂</p>
